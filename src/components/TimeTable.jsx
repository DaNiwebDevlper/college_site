...
const TimeTable = () => {
        ...
        <div className="bg-black/10 w-full flex flex-col items-center">
            ...
            <div className="w-[80%] my-5">
                <h1 className="text-rose-700 text-2xl font-semibold">
                    Time Table of BS Programs & Intermidate
                </h1>
                <p className="text-black/70 my-3">
                    Here you can download and view the time table of BS Programs and also
                    Intermediate, to simply download and view the time table click the "Download & View" button in table
                </p>
            </div>
    ...
    shadow-black/20 mt-9">
                <tr className="border-b border-rose-500 bg-rose-500 text-white">
                    <th
        ...
        uppercase md:min-w-[200px] min-w-[100px] text-center"
          ...
          text-center max-w-[150px]  md:max-w-[400px] "
                        ...
                        <td
                            ...
                            first-letter text-center max-w-[150px] md:max-w-[400px]"
                        >
                            <a
