...
const YTVideo = () => {
  // const videoId = "www.youtube.com/embed/xNRJwmlRBNU?si=pOHNvY1k58gir2F2";
  ...
  return (
    <div className="h-[90vh] w-full flex md:justify-between items-center flex-col gap-y-5 mt-5 md:flex-row">
